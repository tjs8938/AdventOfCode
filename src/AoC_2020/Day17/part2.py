from src.Utility.MatrixPrint4d import position_to_key, find_neighboring_positions, dict_to_matrix
...
def count_neighbors():
    ...
    for pos, cube in starting_state.items():
        ...
        #         all_cubes[neighbor] = Cube(neighbor, INACTIVE)
        #
        # if neighbor_count == 0 and cube.state == INACTIVE:
        #     del all_cubes[pos]
        # else:
