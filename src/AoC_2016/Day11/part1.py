...
start_state.generators = [[THULIUM, PLUTONIUM, STRONTIUM], [], [PROMETHIUM, RUTHENIUM], []]
start_state.microchips = [[THULIUM], [PLUTONIUM, STRONTIUM], [PROMETHIUM, RUTHENIUM], []]

end_state: State = State()
end_state.elevator = 3
end_state.generators = [[], [], [], [THULIUM, PLUTONIUM, STRONTIUM, PROMETHIUM, RUTHENIUM]]
end_state.microchips = [[], [], [], [THULIUM, PLUTONIUM, STRONTIUM, PROMETHIUM, RUTHENIUM]]
