...
def verify_pw():
    ...
    double_index_1 = -1
    double_index_2 = -1
    for index in range(1, len(current_pw)):
        found_straight = found_straight or (index < len(current_pw) - 1 and current_pw[index-1]+1 == current_pw[index] == current_pw[index+1]-1)
